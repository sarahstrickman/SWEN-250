...
extern int add_node_before_current( struct linked_list *p_list, char *word ) ;
extern int insert_sorted( struct linked_list *p_list, char *word ) ;
extern void alphabetize( struct linked_list *p_list ) ;
